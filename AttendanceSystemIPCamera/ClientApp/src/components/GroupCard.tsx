	...
	public render() {
		...
		return (
			<Card className="group shadow">
				<Row>
					<Col span={22}>
						<Title level={4}>{group.code} - {group.name}</Title>
					</Col>
					<Col span={2}>
				...
				<div className="description-container">
					<div className="description">
						...
						<span>
							...
							{group.attendees.length > 1 ? 'attendees' : 'attendee'}
						</span>
					</div>
					<div className="description">
						<Icon type="calendar" />
						<span>
							...
							{group.sessions.length > 1 ? 'sessions' : 'session'}
						</span>
					</div>
					<div className="description">
						<Icon type="history" />
				...
				<div className="actions">
					<Button className="past-button" type="link">
						Past sessions
					</Button>
					<Button className="take-attendance-button" type="primary">
						Take attendance
					</Button>
				</div>
			</Card>
