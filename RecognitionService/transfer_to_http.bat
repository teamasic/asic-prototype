...
start vlc -vvv -Idummy %1 --sout #transcode{vcodec=MJPG,venc=ffmpeg{strict=1},fps=10,width=1000,height=562}:standard{access=http{mime=multipart/x-mixed-replace;boundary=--7b3cc56e5f51db803f790dad720ed50a},mux=mpjpeg,dst=:%2}
