...
start vlc -vvv -Idummy %1 --sout #transcode{vcodec=MJPG,venc=ffmpeg{strict=1},fps=50,width=1920,height=1080}:standard{access=http{mime=multipart/x-mixed-replace;boundary=--7b3cc56e5f51db803f790dad720ed50a},mux=mpjpeg,dst=:%2}
